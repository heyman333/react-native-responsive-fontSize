...
jest.mock("../node_modules/react-native/Libraries/Utilities/Dimensions");
jest.mock("react-native-iphone-x-helper");
describe("react-native-responsive-fontsize", () => {
  jest.mock(rnLib + "/Components/StatusBar/StatusBar", () => ({
    currentHeight: 100,
  }));
  ...
  test("when width is bigger than RFValue", () => {
    Dimensions.get.mockImplementationOnce(
      jest.fn(() => ({ width: 680, height: 100 }))
    );
    isIphoneX.mockReturnValue(true);
